...
export function getList(data) {
  return request({
    url: "/api/v1/resource/video/findPage",
    method: "get",
    params: data,
  });
}
...
export function doInsert(data) {
  return request({
    url: "/api/v1/resource/video/insert",
    method: "post",
    data,
  });
}
...
export function doUpdate(data) {
  return request({
    url: "/api/v1/resource/video/update",
    method: "post",
    data,
  });
}
...
export function doDeleteAll(data) {
  return request({
    url: "/api/v1/resource/video/delAll",
    method: "post",
    params: data,
  });
}
